...
load(url("https://github.com/tomvogl/econ121/raw/main/data/cps18.rds"))
...
# the male - female wage gap, and I want the female-male wage gap.
...
# To match the approach in Problem 7, we need to allow
...
# find that the female/male ratio is .09 above the null hypothesis
# of 1, i.e. the ratio is 1.09. The p-value on the test is <0.001,
# so the difference from 1 is statistically significant..
hypotheses(interacted, "edyrs/(edyrs+edyrs_m)=1")
