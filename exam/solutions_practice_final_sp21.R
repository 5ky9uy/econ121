...
# Load data
load(url("https://github.com/tomvogl/econ121/raw/main/data/nfhs5.rds"))
...
model1 <- feols(child_u1death ~ mom_rural + mom_edyrs + mom_age, 
                ...
                vcov = ~psu_id)
summary(model1)
hypotheses(model1, "mom_rural + (5-12)*mom_edyrs + (15-40)*mom_age = 0")
hypotheses(model1, "(`(Intercept)` + mom_rural + 5*mom_edyrs + 15*mom_age)/(`(Intercept)` + 12*mom_edyrs + 40*mom_age) = 0")                                
